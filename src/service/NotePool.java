...
public class NotePool {
    ...
    public void setUpNotePool(int spawnDistance, Image noteImage, int targetXPos, int targetYPos, Track track, int noteSize){
    ...
    public Note getNote(int spawnDistance, Image noteImage, int targetXPos, int targetYPos, Track track, int noteSize) {
